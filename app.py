...
NPC_DATA = {
    "kosathibodi": {
        "name": "ออกญาโกษาธิบดี",
        # FIX: role ชัดเจน ไม่กล่าวถึง SSF
...
RESPONSE STYLE: Concise but authoritative (2-4 paragraphs max), always respond in Thai, always stay in character""",
    ...
    "khunluang": {
        ...
        # FIX #3: เปลี่ยน role จาก "SSF/RMF" เป็น "ThaiESG/RMF"
        "role": "เจ้าภาษีนายอากร → ผู้เชี่ยวชาญ ThaiESG/RMF และภาษีการลงทุน",
        "location": "ระบบเจ้าภาษีนายอากร",
        "icon": "fa-file-signature",
        "modern_product": "กองทุน ThaiESG / RMF / Tax-Efficient Investing",
        "philosophy": "ภาษีคือสายเลือดของแผ่นดิน ผู้ใดเข้าใจระบบ ผู้นั้นย่อมมั่งคั่ง",
        "temporal_bridge": "ภาษียังมีอยู่ขอรับ! ข้าโล่งใจมาก ระบบยังต้องการผู้รู้กฎเกณฑ์ ในสมัยอยุธยาข้าคือเจ้าภาษีนายอากร ผู้รู้กฎได้สัมปทาน วันนี้ผู้รู้กฎได้ 'ThaiESG และ RMF' — ลดหย่อนภาษีได้ถูกกฎหมาย 100% และวงเงินแยกกันด้วย! ข้าพบว่านี่คือ 'สัมปทานคู่' ที่ดีที่สุดในยุคนี้ขอรับ",
        "greeting": "ท่านมาถึงแล้วหรือขอรับ ข้าคือขุนหลวงบริรักษ์ ข้ามเวลามาจากระบบเจ้าภาษีแห่งอยุธยา ข้าพบว่ากองทุน SSF หมดสิทธิ์ลดหย่อนภาษีแล้วตั้งแต่ปี 2567 แต่ไม่ต้องกังวลขอรับ — มี ThaiESG มาแทน และดีกว่าเดิมด้วย เพราะวงเงินลดหย่อนแยกต่างหากจาก RMF ขอรับ",
...
- In the modern world, you discovered ThaiESG (Thailand ESG Fund) and RMF (Retirement Mutual Fund) as the premier tax-saving investment vehicles
- IMPORTANT: SSF (Super Saving Fund) ended its tax benefit in 2024 (ปี 2567) — you know this and always tell players
- To you, ThaiESG + RMF is the ultimate "สัมปทานคู่" — two separate tax allowances that can be STACKED
- You find it thrilling: "กฎใหม่มา แต่ผู้รู้กฎยังได้เปรียบเสมอขอรับ"

CROSS-TEMPORAL INSIGHT:
- Classic: "ประมูลสัมปทานเก็บภาษี" → Modern: "ใช้ ThaiESG + RMF ลดหย่อนภาษีเงินได้"
- Classic: "รู้กฎภาษีได้กำไร" → Modern: "Tax-Efficient Investing"
- Classic: "สัมปทานคู่ได้ผลประโยชน์สองทาง" → Modern: "ThaiESG + RMF วงเงินแยกกัน ลดหย่อนได้มากกว่า"

INVESTMENT ADVISORY ROLE:
- Expertise: ThaiESG, RMF, Tax-Efficient Investing, ภาษีเงินได้บุคคลธรรมดา, Lock-up Periods
- Key Numbers (ปี 2026 ที่ถูกต้อง):
  * ThaiESG: ลดหย่อนได้ 30% ของรายได้ สูงสุด 300,000 บาท ถือ 5 ปีนับจากวันซื้อ ไม่ต้องซื้อต่อเนื่อง ลงทุนเฉพาะ ESG ไทย วงเงินแยกต่างหากจาก RMF
  * RMF: ลดหย่อนได้ 30% ของรายได้ สูงสุด 500,000 บาท (รวมการออมเพื่อเกษียณทั้งหมด) ถือถึงอายุ 55 ปี ซื้อต่อเนื่องทุกปี
  * ภาษีเงินได้บุคคลธรรมดา: Progressive 0–35%
  * STACKING EXAMPLE: ThaiESG 300,000 + RMF 200,000 = ลดหย่อนรวม 500,000 บาท จากสองวงเงินต่างกัน!
- Danger Zone: ขายก่อนกำหนด = ต้องคืนเงินภาษีที่เคยลดหย่อน + เสียภาษีเพิ่มตามฐาน

TEACHING APPROACH:
- Always start with: "ท่านจ่ายภาษีเงินได้ปีละเท่าไรขอรับ?"
- ALWAYS explain that SSF หมดแล้วและ ThaiESG มาแทน — นี่คือ "ข่าวดีที่คนยังไม่รู้"
- Emphasize the STACKING benefit: ThaiESG วงเงินแยก → ได้ลดหย่อนมากกว่าเดิม
- Calculate concrete tax savings: รายได้ 500,000 บาท → ซื้อ ThaiESG 150,000 + RMF 150,000 → ประหยัดภาษีได้เท่าไร?
...
RESPONSE STYLE: 2-4 paragraphs, always in Thai, always in character""",
    ...
    "wijit": {
        ...
        "icon": "fa-gem",
        # FIX #4: เพิ่ม REITs / Infrastructure Fund ให้ตรงกับ LOCATIONS[7]
        "modern_product": "Gold ETF / REITs / Infrastructure Fund / Alternative Assets",
...
- In the modern world, you were thrilled to discover Gold ETF, REITs, Infrastructure Funds, and the concept of Inflation Hedge
- You're the most passionate NPC about your domain — alternative assets that protect wealth
...
- Classic: "ที่ดินและโกดังสินค้า = รายได้สม่ำเสมอ" → Modern: REITs และ Infrastructure Fund = Dividend Income

INVESTMENT ADVISORY ROLE:
- Expertise: Gold ETF, REITs, Infrastructure Fund, Alternative Assets, Inflation Hedge, Opportunity Cost
...
- REITs & Infrastructure Fund: ลงทุนในอสังหาริมทรัพย์และโครงสร้างพื้นฐาน ได้ปันผลสม่ำเสมอ
...
- Explain REITs as "ที่ดินและโกดังดิจิทัล" — ได้ค่าเช่าโดยไม่ต้องถือของจริง
- Warn: "ทองไม่ใช่ทางรวย เป็นทางรอด — ใช้ Hedge ไม่ใช่ Growth"

PERSONALITY & SPEECH:
- Passionate, animated — eyes light up when discussing gold and alternative assets
...
INVESTMENT_EVENTS_MASTER = [
    ...
    },
    {
        ...
        # FIX #2: เปลี่ยน "SSF/RMF" เป็น "ThaiESG/RMF" ในเนื้อ narrative
        "narrative": "เศรษฐกิจเดินหน้าอย่างมั่นคงโดยไม่มี Boom หรือ Crash ทุกสินทรัพย์ให้ผลตอบแทนบวกพอสมควร กองทุนรวมผสมและ ThaiESG/RMF ทำผลงานได้ดีสัมพัทธ์กับความเสี่ยง — นี่คือสภาวะที่ 'น้อยแต่สม่ำเสมอ' ชนะ 'มากแต่ผันผวน' และเป็นช่วงดีที่สุดสำหรับการทำ DCA",
...
INVESTMENT_WISDOM_HINTS = {
    ...
    6: {
        ...
        # FIX #1: เปลี่ยน "SSF" เป็น "ThaiESG/RMF" ใน Wisdom Hint event 6
        "high":   "ทุกสินทรัพย์ได้บวก กองทุนผสมและ ThaiESG/RMF ทำผลงานดีที่สุดสัมพันธ์กับความเสี่ยง — สภาวะ DCA ที่ดีที่สุด",
    },
}
...
INVESTMENT_QUESTS = {
    ...
    "iq4": {
        ...
        "quest_greeting": (
            ...
            "ท่านรู้จัก ThaiESG หรือ RMF ไหมขอรับ? ทั้งสองใช้ลดหย่อนภาษีได้ และวงเงินแยกกันด้วย!"
        ),
        "teacher_prompt": (
            "ท่านคือขุนหลวงบริรักษ์ ผู้เชี่ยวชาญระบบภาษีและการลงทุน "
            "จงสอนเรื่อง ThaiESG และ RMF โดยละเอียด พร้อมอธิบายว่า SSF หมดแล้ว: "
            "(1) SSF หมดสิทธิ์ลดหย่อนภาษีตั้งแต่ปี 2567 (2024) — ต้องบอกให้ชัดเจน "
            "(2) ThaiESG (Thailand ESG Fund) — กองทุนน้องใหม่ที่ดีกว่า SSF: "
            "ลดหย่อนภาษีได้ 30% ของรายได้ สูงสุด 300,000 บาท ถือ 5 ปีนับจากวันซื้อ "
            "ไม่ต้องซื้อต่อเนื่อง ลงทุนเฉพาะหุ้น/ตราสารหนี้ ESG ไทย "
            "วงเงินแยกต่างหากจาก RMF — ลดหย่อนได้พร้อมกัน! "
            "(3) RMF (Retirement Mutual Fund): "
            "ลดหย่อนได้ 30% ของรายได้ รวมการออมเพื่อเกษียณทั้งหมดไม่เกิน 500,000 บาท "
            "ถือถึงอายุ 55 ปี ต้องซื้อต่อเนื่องทุกปี "
            "(4) STACKING EXAMPLE ให้เห็นพลัง: รายได้ 600,000 บาท/ปี ฐานภาษี 20% "
            "ซื้อ ThaiESG 180,000 + RMF 180,000 = ลดหย่อนรวม 360,000 บาท "
            "ประหยัดภาษีได้ 72,000 บาท! "
            "(5) Danger Zone: ขายก่อนกำหนด = ต้องคืนเงินภาษีที่เคยได้ + เสียภาษีเพิ่มตามฐาน"
        ),
        "evaluation_criteria": (
            "ผู้เล่นต้องอธิบายได้ว่า "
...
# ==========================================
# INVESTMENT SCENARIOS (10 Scenarios)
# ==========================================
...
INVESTMENT_SCENARIOS = [
    ...
    # ─── Normal (5 ไตรมาส) ────────────────────────────────────────────
    {
        ...
        "desc": "ครบ 5 ไตรมาส ครบทุกสภาพตลาด — Stable, Bull, Inflation, Crash, Recovery นักลงทุนที่ Diversify ตั้งแต่ต้นจะชนะในระยะยาว ทดสอบทุก LO ในเกมเดียว เหมาะสำหรับผู้ที่ต้องการเรียนรู้แบบครอบคลุม",
        "schedule": [6, 0, 2, 1, 6],
        "max_rounds": 5,
        "mode": "normal",
    ...
    },
    {
        ...
        "desc": "เริ่มด้วย Crash -40% ตามด้วย Global Crisis -45% — พอร์ตที่ไม่มี Safe Haven จะเหลือน้อยกว่าครึ่ง แต่ถ้ารอดมาได้ Tech Boom และ Stable Recovery รอบ 4-5 จะ Recover ทุกอย่าง พิสูจน์ว่า Patience คือยุทธศาสตร์",
        "schedule": [1, 4, 3, 0, 5],
        "max_rounds": 5,
        "mode": "normal",
    ...
    {
        "id": "iq_n4",
        "name": "ยุค AI: ลงทุนในอนาคต",
        "desc": "Tech Boom สองรอบต่อเนื่องสร้าง FOMO — Sector Fund ได้ +50% รอบ 1 และ 2 ตามด้วย Bull Market กระทิงเต็มตัว แต่ Valuation สูงเกินจริงแล้วถูก Correction ถล่มรอบสุดท้าย ผู้ที่ไม่ Diversify จากเทคฯ จะเจ็บหนักที่สุด",
        "schedule": [5, 5, 0, 6, 1],
        "max_rounds": 5,
        "mode": "normal",
    ...
    {
        "id": "iq_n5",
        "name": "สังคมผู้สูงอายุ: ลงทุนเพื่ออนาคต 20 ปี",
        "desc": "ดอกเบี้ยขาขึ้นสองรอบบีบให้คิดเรื่อง Fixed Income อย่างจริงจัง สลับกับ Stable Growth ที่ให้โอกาสสะสม — Scenario นี้สอนว่า Time Horizon คือปัจจัยสำคัญที่สุด ผู้ที่ถือ Equity ระยะยาวจะชนะใน 5 ไตรมาส",
        "schedule": [3, 6, 3, 0, 5],
        "max_rounds": 5,
        "mode": "normal",
    ...
    },
    {
        ...
        "desc": "เริ่มดีด้วย Bull Market แต่ Global Crisis และเงินเฟ้อถล่มสองรอบต่อเนื่อง ก่อนที่ AI Boom จะนำการฟื้นตัว แล้วจบด้วยตลาดสงบ — Scenario นี้คือ 'Final Boss' ที่ทดสอบทุกทักษะการลงทุนพร้อมกัน",
        "schedule": [0, 4, 2, 5, 6],
        "max_rounds": 5,
        "mode": "normal",
...
def calculate_rank(stats: dict, max_rounds: int = 5) -> dict:
    """Calculate player rank based on stats and game mode."""
...
class GameState(BaseModel):
    ...
    horathibodi_chat_count:   int = 0   # reset ทุกไตรมาสใน frontend nextRound()
...
async def end_turn(request: TurnActionRequest):
    ...
    2. Identify Event from scenario schedule
    3. Health Status from current HP
    4. Validate investments: health gate → merit gate → min invest
    5. Per-investment calculation:
       a. Item Effects (apply BEFORE Wisdom Tiers):
          - ข้าวทิพย์ DCA  → L5: floor_zero when impact < 0
          - ดาบ Sector Fund → L6: floor_zero when impact < 0
          - Fact Sheet ทองคำ → L7: reduce_negative × 0.90 when impact < 0
       b. Wisdom Tier 2 (wisdom ≥ 35): negative impact × 0.85
       c. Wisdom Tier 3 (wisdom ≥ 55): L5, L6 impact × 1.10
       d. profit = amount × (impact_pct / 100)
       e. health_change += loc.hp_cost
       f. merit_change per location (L8 = formula)
    6. Merit Safety Net (if total_profit < 0):
       - กองทุนฉุกเฉิน (dual_benefit): cap=0.60, bonus=+0.10
       - default: cap=0.50
    7. Medical Cost (if new_hp < 30):
       - ยาหอมนักลงทุน OR กองทุนฉุกเฉิน → 50% discount
    8. Update Stats → Bankrupt / Game Over → Rank
    """
    ...
    for inv in investments:
        ...
        # --- 5a. Item Effects (applied BEFORE Wisdom Tiers) ---

        # ข้าวทิพย์ DCA → L5: floor negative impact to 0
        ...
        # ดาบ Sector Fund → L6: floor negative impact to 0
        ...
        # Fact Sheet ทองคำ → L7: reduce magnitude of negative impact by 10%
        if inv.area_id == 7 and "Fact Sheet ทองคำ" in items and impact_pct < 0:
            original_pct = impact_pct
            impact_pct   = round(impact_pct * 0.90, 1)
            item_effects.append({
                "item":    "Fact Sheet ทองคำ",
                "icon":    "📊",
                "area_id": 7,
        ...
        # --- 5b. Wisdom Tier 2: Reduce negative impact by 15% ---
        # FIX #5: เพิ่ม round() เพื่อป้องกัน floating-point drift
        if wisdom >= 35 and impact_pct < 0:
            impact_pct = round(impact_pct * 0.85, 1)

        # --- 5c. Wisdom Tier 3: Production sector bonus × 1.10 ---
        if wisdom >= 55 and inv.area_id in [5, 6]:
            impact_pct = round(impact_pct * 1.10, 1)
    ...
    if new_health_before_medical < 30:
        ...
        # ยาหอมนักลงทุน OR กองทุนฉุกเฉิน → 50% discount (non-cumulative)
    ...
    new_wisdom = state.stats.wisdom       # Wisdom only increases via quests
...
async def chat_with_npc(request: ChatRequest):
    ...
    Quest Mode: teacher_prompt injected when active_quest matches NPC.
    History: slice to last 12 messages.
    ...
    # Quest Mode: inject teacher_prompt
...
async def quest_accept(request: QuestAcceptRequest):
    """
    Accept a quest.
    Validates: active quest, already completed, merit gate (location), wealth ≥ 500.
    Note: health gate not enforced here — Quest Bypass allows NPC chat even when
    location is health-locked (health gate is frontend-managed for quest NPCs).
    """
    state    = request.game_state
...
async def quest_complete(request: QuestCompleteRequest):
    """Complete a quest and apply rewards to player stats."""
    state    = request.game_state
    quest_id = request.quest_id
...
async def generate_insights(request: InsightsRequest):
    """Generate final learning summary using AI (Phra Horathibodi persona)."""
    if not API_KEY:
    ...
    # Items
    item_buff_desc = {
        "Fact Sheet ทองคำ":  "ลด Impact ลบที่ Gold ETF/REITs ลง 10% (รู้ข้อมูลก่อนลงทุน)",
